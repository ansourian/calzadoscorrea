document.addEventListener("DOMContentLoaded", function () {
  ...
  const productos = [
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/135 - 21.webp",
        "../assets/img/ready to wear/135 - 22.webp",
        "../assets/img/ready to wear/135 - 23.webp",
        "../assets/img/ready to wear/123 - 8.webp",
      ],
    },
    {
      id: "1122-Natural",
      ...
      imagenes: [
        "../assets/img/ready to wear/123 - 5.webp",
        "../assets/img/ready to wear/123 - 6.webp",
        "../assets/img/ready to wear/123 - 7.webp",
        "../assets/img/ready to wear/123 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/135 - 24.webp",
        "../assets/img/ready to wear/135 - 25.webp",
        "../assets/img/ready to wear/135 - 26.webp",
        "../assets/img/ready to wear/123 - 11.webp",
      ],
    },
    {
      id: "1122-Tabaco",
      ...
      imagenes: [
        "../assets/img/ready to wear/123 - 9.webp",
        "../assets/img/ready to wear/126 - 2.webp",
        "../assets/img/ready to wear/123 - 10.webp",
        "../assets/img/ready to wear/123 - 11.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/138 - 4.webp",
        "../assets/img/ready to wear/138 - 5.webp",
        "../assets/img/ready to wear/138 - 6.webp",
        "../assets/img/ready to wear/123 - 11.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/122 - 29.webp",
        "../assets/img/ready to wear/122 - 30.webp",
        "../assets/img/ready to wear/122 - 31.webp",
        "../assets/img/ready to wear/122 - 32.webp",
      ],
    },
    {
      id: "1122-Verde",
      ...
      imagenes: [
        "../assets/img/ready to wear/123 - 1.webp",
        "../assets/img/ready to wear/123 - 2.webp",
        "../assets/img/ready to wear/123 - 3.webp",
        "../assets/img/ready to wear/123 - 4.webp",
      ],
    },
    {
      id: "1122-Rojo",
      ...
      imagenes: [
        "../assets/img/ready to wear/147 - 3.webp",
        "../assets/img/ready to wear/147 - 4.webp",
        "../assets/img/ready to wear/147 - 5.webp",
        "../assets/img/ready to wear/123 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/147 - 6.webp",
        "../assets/img/ready to wear/147 - 7.webp",
        "../assets/img/ready to wear/147 - 8.webp",
        "../assets/img/ready to wear/123 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/136 - 9.webp",
        "../assets/img/ready to wear/136 - 10.webp",
        "../assets/img/ready to wear/136 - 11.webp",
        "../assets/img/ready to wear/123 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/136 - 12.webp",
        "../assets/img/ready to wear/136 - 13.webp",
        "../assets/img/ready to wear/136 - 14.webp",
        "../assets/img/ready to wear/123 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/136 - 15.webp",
        "../assets/img/ready to wear/136 - 16.webp",
        "../assets/img/ready to wear/136 - 17.webp",
        "../assets/img/ready to wear/123 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/136 - 18.webp",
        "../assets/img/ready to wear/136 - 19.webp",
        "../assets/img/ready to wear/136 - 20.webp",
        "../assets/img/ready to wear/123 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/136 - 22.webp",
        "../assets/img/ready to wear/136 - 23.webp",
        "../assets/img/ready to wear/136 - 24.webp",
        "../assets/img/ready to wear/123 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/136 - 25.webp",
        "../assets/img/ready to wear/136 - 26.webp",
        "../assets/img/ready to wear/136 - 27.webp",
        "../assets/img/ready to wear/123 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/136 - 28.webp",
        "../assets/img/ready to wear/136 - 29.webp",
        "../assets/img/ready to wear/136 - 30.webp",
        "../assets/img/ready to wear/123 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/132 - 5.webp",
        "../assets/img/ready to wear/132 - 6.webp",
        "../assets/img/ready to wear/132 - 7.webp",
        "../assets/img/ready to wear/132 - 8.webp",
      ],
    },
    {
      id: "1108-Guinda",
      ...
      imagenes: [
        "../assets/img/ready to wear/127 - 5.webp",
        "../assets/img/ready to wear/127 - 6.webp",
        "../assets/img/ready to wear/127 - 7.webp",
        "../assets/img/ready to wear/127 - 8.webp",
      ],
    },
    {
      id: "1108-Natural",
      ...
      imagenes: [
        "../assets/img/ready to wear/137 - 1.webp",
        "../assets/img/ready to wear/137 - 2.webp",
        "../assets/img/ready to wear/137 - 3.webp",
        "../assets/img/ready to wear/127 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/137 - 4.webp",
        "../assets/img/ready to wear/137 - 5.webp",
        "../assets/img/ready to wear/137 - 6.webp",
        "../assets/img/ready to wear/127 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/137 - 10.webp",
        "../assets/img/ready to wear/137 - 11.webp",
        "../assets/img/ready to wear/137 - 12.webp",
        "../assets/img/ready to wear/127 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/137 - 7.webp",
        "../assets/img/ready to wear/137 - 8.webp",
        "../assets/img/ready to wear/137 - 9.webp",
        "../assets/img/ready to wear/127 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/137 - 13.webp",
        "../assets/img/ready to wear/137 - 14.webp",
        "../assets/img/ready to wear/137 - 15.webp",
        "../assets/img/ready to wear/127 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/127 - 9.webp",
        "../assets/img/ready to wear/127 - 10.webp",
        "../assets/img/ready to wear/127 - 11.webp",
        "../assets/img/ready to wear/127 - 12.webp",
      ],
    },
    {
      id: "1107-Guinda",
      ...
      imagenes: [
        "../assets/img/ready to wear/135 - 13.webp",
        "../assets/img/ready to wear/135 - 14.webp",
        "../assets/img/ready to wear/135 - 15.webp",
        "../assets/img/ready to wear/127 - 12.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/137 - 20.webp",
        "../assets/img/ready to wear/137 - 21.webp",
        "../assets/img/ready to wear/137 - 22.webp",
        "../assets/img/ready to wear/127 - 12.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/137 - 23.webp",
        "../assets/img/ready to wear/137 - 24.webp",
        "../assets/img/ready to wear/137 - 25.webp",
        "../assets/img/ready to wear/127 - 12.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/135 - 10.webp",
        "../assets/img/ready to wear/135 - 11.webp",
        "../assets/img/ready to wear/135 - 12.webp",
        "../assets/img/ready to wear/131 - 35.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/127 - 13.webp",
        "../assets/img/ready to wear/127 - 14.webp",
        "../assets/img/ready to wear/131 - 34.webp",
        "../assets/img/ready to wear/131 - 35.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/127 - 17.webp",
        "../assets/img/ready to wear/127 - 18.webp",
        "../assets/img/ready to wear/127 - 19.webp",
        "../assets/img/ready to wear/127 - 20.webp",
      ],
    },
    {
      id: "1103-Negro",
      ...
      imagenes: [
        "../assets/img/ready to wear/121 - 1.webp",
        "../assets/img/ready to wear/121 - 2.webp",
        "../assets/img/ready to wear/121 - 3.webp",
        "../assets/img/ready to wear/121 - 11.webp",
      ],
    },
    {
      id: "1103-Suela",
      ...
      imagenes: [
        "../assets/img/ready to wear/135 - 7.webp",
        "../assets/img/ready to wear/135 - 8.webp",
        "../assets/img/ready to wear/135 - 9.webp",
        "../assets/img/ready to wear/121 - 11.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/121 - 4.webp",
        "../assets/img/ready to wear/121 - 5.webp",
        "../assets/img/ready to wear/121 - 6.webp",
        "../assets/img/ready to wear/121 - 7.webp",
      ],
    },
    {
      id: "1103-Marron",
      ...
      imagenes: [
        "../assets/img/ready to wear/121 - 8.webp",
        "../assets/img/ready to wear/121 - 9.webp",
        "../assets/img/ready to wear/121 - 10.webp",
        "../assets/img/ready to wear/121 - 11.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/127 - 1.webp",
        "../assets/img/ready to wear/127 - 2.webp",
        "../assets/img/ready to wear/127 - 3.webp",
        "../assets/img/ready to wear/127 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/126 - 12.webp",
        "../assets/img/ready to wear/126 - 13.webp",
        "../assets/img/ready to wear/126 - 14.webp",
        "../assets/img/ready to wear/126 - 15.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/135 - 1.webp",
        "../assets/img/ready to wear/135 - 2.webp",
        "../assets/img/ready to wear/135 - 3.webp",
        "../assets/img/ready to wear/126 - 15.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/132 - 9.webp",
        "../assets/img/ready to wear/132 - 10.webp",
        "../assets/img/ready to wear/132 - 11.webp",
        "../assets/img/ready to wear/126 - 15.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/132 - 12.webp",
        "../assets/img/ready to wear/132 - 13.webp",
        "../assets/img/ready to wear/132 - 14.webp",
        "../assets/img/ready to wear/126 - 15.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/135 - 4.webp",
        "../assets/img/ready to wear/135 - 5.webp",
        "../assets/img/ready to wear/135 - 6.webp",
        "../assets/img/ready to wear/126 - 15.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/132 - 15.webp",
        "../assets/img/ready to wear/132 - 16.webp",
        "../assets/img/ready to wear/132 - 17.webp",
        "../assets/img/ready to wear/126 - 15.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/132 - 18.webp",
        "../assets/img/ready to wear/132 - 19.webp",
        "../assets/img/ready to wear/132 - 20.webp",
        "../assets/img/ready to wear/126 - 15.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/131 - 8.webp",
        "../assets/img/ready to wear/131 - 9.webp",
        "../assets/img/ready to wear/131 - 10.webp",
        "../assets/img/ready to wear/131 - 11.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/131 - 4.webp",
        "../assets/img/ready to wear/131 - 5.webp",
        "../assets/img/ready to wear/131 - 6.webp",
        "../assets/img/ready to wear/131 - 7.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/131 - 12.webp",
        "../assets/img/ready to wear/131 - 13.webp",
        "../assets/img/ready to wear/131 - 14.webp",
        "../assets/img/ready to wear/131 - 7.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/139 - 4.webp",
        "../assets/img/ready to wear/139 - 5.webp",
        "../assets/img/ready to wear/139 - 6.webp",
        "../assets/img/made by order/112 - 24.webp",
      ],
    },
    {
      id: "Swann-Negro",
      ...
      imagenes: [
        "../assets/img/ready to wear/139 - 1.webp",
        "../assets/img/ready to wear/139 - 2.webp",
        "../assets/img/ready to wear/139 - 3.webp",
        "../assets/img/made by order/112 - 24.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/131 - 18.webp",
        "../assets/img/ready to wear/131 - 19.webp",
        "../assets/img/ready to wear/131 - 20.webp",
        "../assets/img/ready to wear/131 - 11.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/131 - 15.webp",
        "../assets/img/ready to wear/131 - 16.webp",
        "../assets/img/ready to wear/131 - 17.webp",
        "../assets/img/ready to wear/131 - 7.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/131 - 21.webp",
        "../assets/img/ready to wear/131 - 22.webp",
        "../assets/img/ready to wear/131 - 23.webp",
        "../assets/img/ready to wear/131 - 7.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/131 - 24.webp",
        "../assets/img/ready to wear/131 - 25.webp",
        "../assets/img/ready to wear/131 - 26.webp",
        "../assets/img/ready to wear/131 - 27.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/148 - 12.webp",
        "../assets/img/ready to wear/148 - 13.webp",
        "../assets/img/ready to wear/148 - 14.webp",
        "../assets/img/ready to wear/148 - 15.webp",
      ],
    },
    {
      id: "2-Hebillas-Negro",
      ...
      estilo: "READY TO WEAR",
      descripcion:
        "Este es un modelo de estilo elegante que se distingue por sus dos hebillas en lugar de cordones (de las cuales una cuenta con un elástico), lo que le confiere una apariencia sofisticada y versátil, adecuada tanto para ocasiones formales como informales.",
      color: "Negro",
      tipoCuero: "Cuero Vacuno",
      codigo: "2 Hebillas",
      imagenPrincipal: "../assets/img/ready to wear/130 - 41.webp",
      imagenes: [
        "../assets/img/ready to wear/130 - 41.webp",
        "../assets/img/ready to wear/130 - 42.webp",
        "../assets/img/ready to wear/130 - 43.webp",
        "../assets/img/ready to wear/130 - 44.webp",
      ],
    },
    {
      id: "2-Hebillas-Suela",
      ...
      imagenes: [
        "../assets/img/ready to wear/130 - 45.webp",
        "../assets/img/ready to wear/130 - 46.webp",
        "../assets/img/ready to wear/130 - 47.webp",
        "../assets/img/ready to wear/130 - 44.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/130 - 48.webp",
        "../assets/img/ready to wear/130 - 49.webp",
        "../assets/img/ready to wear/130 - 50.webp",
        "../assets/img/ready to wear/130 - 44.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/130 - 54.webp",
        "../assets/img/ready to wear/130 - 55.webp",
        "../assets/img/ready to wear/130 - 56.webp",
        "../assets/img/ready to wear/130 - 44.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/115 - 13.webp",
        "../assets/img/ready to wear/115 - 14.webp",
        "../assets/img/ready to wear/115 - 15.webp",
        "../assets/img/ready to wear/115 - 16.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/130 - 5.webp",
        "../assets/img/made by order/130 - 6.webp",
        "../assets/img/made by order/130 - 7.webp",
        "../assets/img/made by order/130 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/130 - 9.webp",
        "../assets/img/made by order/130 - 10.webp",
        "../assets/img/made by order/130 - 11.webp",
        "../assets/img/made by order/130 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/130 - 12.webp",
        "../assets/img/made by order/130 - 13.webp",
        "../assets/img/made by order/130 - 14.webp",
        "../assets/img/made by order/130 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/122 - 26.webp",
        "../assets/img/ready to wear/122 - 27.webp",
        "../assets/img/ready to wear/122 - 28.webp",
        "../assets/img/ready to wear/117 - 19.webp",
      ],
    },
    {
      id: "Sneaker-Marron",
      ...
      imagenes: [
        "../assets/img/ready to wear/117 - 10.webp",
        "../assets/img/ready to wear/117 - 11.webp",
        "../assets/img/ready to wear/117 - 12.webp",
        "../assets/img/ready to wear/117 - 19.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/122 - 20.webp",
        "../assets/img/ready to wear/122 - 21.webp",
        "../assets/img/ready to wear/122 - 22.webp",
        "../assets/img/ready to wear/117 - 19.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/122 - 17.webp",
        "../assets/img/ready to wear/122 - 18.webp",
        "../assets/img/ready to wear/122 - 19.webp",
        "../assets/img/ready to wear/117 - 19.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/117 - 13.webp",
        "../assets/img/ready to wear/117 - 14.webp",
        "../assets/img/ready to wear/117 - 15.webp",
        "../assets/img/ready to wear/117 - 19.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/133 - 19.webp",
        "../assets/img/ready to wear/133 - 20.webp",
        "../assets/img/ready to wear/133 - 21.webp",
        "../assets/img/ready to wear/133 - 22.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/133 - 23.webp",
        "../assets/img/ready to wear/133 - 24.webp",
        "../assets/img/ready to wear/133 - 25.webp",
        "../assets/img/ready to wear/133 - 22.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/148 - 5.webp",
        "../assets/img/ready to wear/148 - 6.webp",
        "../assets/img/ready to wear/148 - 7.webp",
        "../assets/img/ready to wear/148 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/148 - 16.webp",
        "../assets/img/ready to wear/148 - 17.webp",
        "../assets/img/ready to wear/148 - 18.webp",
        "../assets/img/ready to wear/148 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/149 - 12.webp",
        "../assets/img/ready to wear/149 - 13.webp",
        "../assets/img/ready to wear/149 - 14.webp",
        "../assets/img/ready to wear/148 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/148 - 9.webp",
        "../assets/img/ready to wear/148 - 10.webp",
        "../assets/img/ready to wear/148 - 11.webp",
        "../assets/img/ready to wear/148 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/126 - 4.webp",
        "../assets/img/ready to wear/126 - 5.webp",
        "../assets/img/ready to wear/126 - 6.webp",
        "../assets/img/ready to wear/126 - 7.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/117 - 23.webp",
        "../assets/img/ready to wear/117 - 24.webp",
        "../assets/img/ready to wear/117 - 25.webp",
        "../assets/img/ready to wear/117 - 26.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/142 - 27.webp",
        "../assets/img/ready to wear/142 - 28.webp",
        "../assets/img/ready to wear/142 - 29.webp",
        "../assets/img/ready to wear/142 - 30.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/126 - 8.webp",
        "../assets/img/ready to wear/126 - 9.webp",
        "../assets/img/ready to wear/126 - 10.webp",
        "../assets/img/ready to wear/126 - 11.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/145 - 17.webp",
        "../assets/img/ready to wear/145 - 18.webp",
        "../assets/img/ready to wear/145 - 19.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/147 - 12.webp",
        "../assets/img/ready to wear/147 - 13.webp",
        "../assets/img/ready to wear/147 - 14.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/147 - 16.webp",
        "../assets/img/ready to wear/147 - 17.webp",
        "../assets/img/ready to wear/147 - 18.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/147 - 19.webp",
        "../assets/img/ready to wear/147 - 20.webp",
        "../assets/img/ready to wear/147 - 21.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/147 - 22.webp",
        "../assets/img/ready to wear/147 - 23.webp",
        "../assets/img/ready to wear/147 - 24.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/150 - 29.webp",
        "../assets/img/ready to wear/150 - 30.webp",
        "../assets/img/ready to wear/150 - 31.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/141 - 21.webp",
        "../assets/img/ready to wear/141 - 22.webp",
        "../assets/img/ready to wear/141 - 23.webp",
        "../assets/img/ready to wear/119 - 20.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/141 - 15.webp",
        "../assets/img/ready to wear/141 - 16.webp",
        "../assets/img/ready to wear/141 - 17.webp",
        "../assets/img/ready to wear/119 - 20.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/119 - 17.webp",
        "../assets/img/ready to wear/119 - 18.webp",
        "../assets/img/ready to wear/119 - 19.webp",
        "../assets/img/ready to wear/119 - 20.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/119 - 21.webp",
        "../assets/img/ready to wear/119 - 22.webp",
        "../assets/img/ready to wear/119 - 23.webp",
        "../assets/img/ready to wear/119 - 24.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/130 - 25.webp",
        "../assets/img/ready to wear/130 - 26.webp",
        "../assets/img/ready to wear/130 - 27.webp",
        "../assets/img/ready to wear/130 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/130 - 29.webp",
        "../assets/img/ready to wear/130 - 30.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/141 - 18.webp",
        "../assets/img/ready to wear/141 - 19.webp",
        "../assets/img/ready to wear/141 - 20.webp",
        "../assets/img/ready to wear/119 - 20.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/130 - 33.webp",
        "../assets/img/ready to wear/130 - 34.webp",
        "../assets/img/ready to wear/130 - 35.webp",
        "../assets/img/ready to wear/130 - 36.webp",
      ],
    },
    {
      id: "Mocasin-Industry",
      ...
      imagenes: [
        "../assets/img/ready to wear/123 - 32.webp",
        "../assets/img/ready to wear/123 - 33.webp",
        "../assets/img/ready to wear/123 - 34.webp",
        "../assets/img/ready to wear/123 - 35.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/145 - 21.webp",
        "../assets/img/ready to wear/145 - 22.webp",
        "../assets/img/ready to wear/145 - 23.webp",
        "../assets/img/ready to wear/145 - 24.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/149 - 5.webp",
        "../assets/img/ready to wear/149 - 6.webp",
        "../assets/img/ready to wear/149 - 7.webp",
        "../assets/img/ready to wear/149 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/149 - 9.webp",
        "../assets/img/ready to wear/149 - 10.webp",
        "../assets/img/ready to wear/149 - 11.webp",
        "../assets/img/ready to wear/149 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/149 - 1.webp",
        "../assets/img/ready to wear/149 - 2.webp",
        "../assets/img/ready to wear/149 - 3.webp",
        "../assets/img/ready to wear/149 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/144 - 1.webp",
        "../assets/img/ready to wear/144 - 2.webp",
        "../assets/img/ready to wear/144 - 3.webp",
        "../assets/img/ready to wear/144 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/144 - 5.webp",
        "../assets/img/ready to wear/144 - 6.webp",
        "../assets/img/ready to wear/144 - 7.webp",
        "../assets/img/ready to wear/144 - 4.webp",
      ],
    },
    {
      ...
      estilo: "READY TO WEAR",
      descripcion:
        "Un clásico de la casa. Esta bota cuenta con una costura redondeada y presenta un diseño clásico con un toque más suave y contemporáneo. Ofrece un equilibrio perfecto entre estilo tradicional y comodidad moderna.",
      color: "Suela",
      tipoCuero: "Cuero Vacuno Graneado",
      codigo: "Bota Petta",
      imagenPrincipal: "../assets/img/ready to wear/144 - 8.webp",
      imagenes: [
        "../assets/img/ready to wear/144 - 8.webp",
        "../assets/img/ready to wear/144 - 9.webp",
        "../assets/img/ready to wear/144 - 10.webp",
        "../assets/img/ready to wear/144 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/144 - 12.webp",
        "../assets/img/ready to wear/144 - 13.webp",
        "../assets/img/ready to wear/144 - 14.webp",
        "../assets/img/ready to wear/144 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/144 - 15.webp",
        "../assets/img/ready to wear/144 - 16.webp",
        "../assets/img/ready to wear/144 - 17.webp",
        "../assets/img/ready to wear/144 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/143 - 8.webp",
        "../assets/img/ready to wear/143 - 9.webp",
        "../assets/img/ready to wear/143 - 10.webp",
        "../assets/img/ready to wear/143 - 7.webp",
      ],
    },
    {
      id: "Bota-ET-Maiz",
      ...
      imagenes: [
        "../assets/img/ready to wear/143 - 4.webp",
        "../assets/img/ready to wear/143 - 5.webp",
        "../assets/img/ready to wear/143 - 6.webp",
        "../assets/img/ready to wear/143 - 7.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/143 - 11.webp",
        "../assets/img/ready to wear/143 - 12.webp",
        "../assets/img/ready to wear/143 - 13.webp",
        "../assets/img/ready to wear/143 - 7.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/112 - 25.webp",
        "../assets/img/made by order/112 - 26.webp",
        "../assets/img/made by order/112 - 27.webp",
        "../assets/img/made by order/112 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/114 - 4.webp",
        "../assets/img/made by order/114 - 5.webp",
        "../assets/img/made by order/114 - 6.webp",
        "../assets/img/made by order/114 - 7.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/142 - 18.webp",
        "../assets/img/made by order/142 - 19.webp",
        "../assets/img/made by order/142 - 20.webp",
        "../assets/img/made by order/114 - 7.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/114 - 15.webp",
        "../assets/img/made by order/114 - 16.webp",
        "../assets/img/made by order/114 - 17.webp",
        "../assets/img/made by order/114 - 18.webp",
      ],
    },
    {
      ...
      tipoCuero: "Shell Cordovan",
      codigo: "1122",
      imagenPrincipal: "../assets/img/made by order/142 - 15.webp",
      imagenes: [
        "../assets/img/made by order/142 - 15.webp",
        "../assets/img/made by order/142 - 16.webp",
        "../assets/img/made by order/142 - 17.webp",
        "../assets/img/made by order/114 - 18.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/142 - 31.webp",
        "../assets/img/made by order/142 - 32.webp",
        "../assets/img/made by order/142 - 33.webp",
        "../assets/img/made by order/114 - 18.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/137 - 16.webp",
        "../assets/img/made by order/137 - 17.webp",
        "../assets/img/made by order/137 - 18.webp",
        "../assets/img/made by order/137 - 19.webp",
      ],
    },
    {
      id: "Swann-Maiz",
      ...
      imagenes: [
        "../assets/img/made by order/112 - 21.webp",
        "../assets/img/made by order/112 - 22.webp",
        "../assets/img/made by order/112 - 23.webp",
        "../assets/img/made by order/112 - 24.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/119 - 5.webp",
        "../assets/img/made by order/119 - 6.webp",
        "../assets/img/made by order/119 - 7.webp",
        "../assets/img/made by order/119 - 8.webp",
      ],
    },
    {
      id: "Swann-Negro",
      ...
      imagenes: [
        "../assets/img/made by order/112 - 13.webp",
        "../assets/img/made by order/112 - 14.webp",
        "../assets/img/made by order/112 - 15.webp",
        "../assets/img/made by order/112 - 16.webp",
      ],
    },
    {
      id: "Swann-Wookie",
      ...
      imagenes: [
        "../assets/img/made by order/146 - 7.webp",
        "../assets/img/made by order/146 - 8.webp",
        "../assets/img/made by order/146 - 9.webp",
        "../assets/img/made by order/146 - 10.webp",
      ],
    },
    {
      id: "Swann-Club-Rojo",
      ...
      imagenes: [
        "../assets/img/made by order/143 - 1.webp",
        "../assets/img/made by order/143 - 2.webp",
        "../assets/img/made by order/143 - 3.webp",
        "../assets/img/made by order/112 - 36.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/ready to wear/130 - 51.webp",
        "../assets/img/ready to wear/130 - 52.webp",
        "../assets/img/ready to wear/133 - 15.webp",
        "../assets/img/ready to wear/130 - 44.webp",
      ],
    },
    {
      ...
      estilo: "MADE TO ORDER",
      descripcion:
        "Esta bota Derby se caracteriza por su estilo picado. Este diseño proporciona mayor comodidad y ajuste, ya que la lengüeta se puede ajustar de acuerdo con el ancho del pie.",
      color: "Negro",
      tipoCuero: "Cuero vacuno",
      codigo: "Bota Alpina",
      imagenPrincipal: "../assets/img/made by order/123 - 15.webp",
      imagenes: [
        "../assets/img/made by order/123 - 15.webp",
        "../assets/img/made by order/112 - 34.webp",
        "../assets/img/made by order/112 - 35.webp",
        "../assets/img/made by order/112 - 36.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/117 - 01.webp",
        "../assets/img/made by order/117 - 02.webp",
        "../assets/img/made by order/126 - 1.webp",
        "../assets/img/made by order/112 - 36.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/130 - 22.webp",
        "../assets/img/made by order/130 - 23.webp",
        "../assets/img/made by order/130 - 24.webp",
        "../assets/img/made by order/112 - 36.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/131 - 28.webp",
        "../assets/img/made by order/131 - 29.webp",
        "../assets/img/made by order/131 - 30.webp",
        "../assets/img/made by order/113 - 27.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/131 - 31.webp",
        "../assets/img/made by order/131 - 32.webp",
        "../assets/img/made by order/131 - 33.webp",
        "../assets/img/made by order/113 - 27.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/85 - 11.webp",
        "../assets/img/made by order/113 - 21.webp",
        "../assets/img/made by order/113 - 22.webp",
        "../assets/img/made by order/113 - 23.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/144 - 21.webp",
        "../assets/img/made by order/144 - 22.webp",
        "../assets/img/made by order/144 - 23.webp",
        "../assets/img/made by order/113 - 27.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/113 - 24.webp",
        "../assets/img/made by order/113 - 25.webp",
        "../assets/img/made by order/113 - 26.webp",
        "../assets/img/made by order/113 - 27.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/114 - 1.webp",
        "../assets/img/made by order/114 - 2.webp",
        "../assets/img/made by order/114 - 3.webp",
        "../assets/img/made by order/113 - 27.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/117 - 03.webp",
        "../assets/img/made by order/117 - 04.webp",
        "../assets/img/made by order/117 - 05.webp",
        "../assets/img/made by order/113 - 27.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/131 - 1.webp",
        "../assets/img/made by order/131 - 2.webp",
        "../assets/img/made by order/131 - 3.webp",
        "../assets/img/made by order/113 - 27.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/133 - 16.webp",
        "../assets/img/made by order/133 - 17.webp",
        "../assets/img/made by order/133 - 18.webp",
        "../assets/img/made by order/113 - 27.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/113 - 1.webp",
        "../assets/img/made by order/113 - 2.webp",
        "../assets/img/made by order/113 - 3.webp",
        "../assets/img/made by order/112 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/112 - 29.webp",
        "../assets/img/made by order/112 - 30.webp",
        "../assets/img/made by order/112 - 31.webp",
        "../assets/img/made by order/112 - 32.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/142 - 37.webp",
        "../assets/img/made by order/142 - 38.webp",
        "../assets/img/made by order/142 - 39.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/141 - 6.webp",
        "../assets/img/made by order/141 - 7.webp",
        "../assets/img/made by order/141 - 8.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/141 - 9.webp",
        "../assets/img/made by order/141 - 10.webp",
        "../assets/img/made by order/141 - 11.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/142 - 34.webp",
        "../assets/img/made by order/142 - 35.webp",
        "../assets/img/made by order/142 - 36.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/142 - 6.webp",
        "../assets/img/made by order/142 - 7.webp",
        "../assets/img/made by order/142 - 8.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/142 - 9.webp",
        "../assets/img/made by order/142 - 10.webp",
        "../assets/img/made by order/142 - 11.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/141 - 24.webp",
        "../assets/img/made by order/141 - 25.webp",
        "../assets/img/made by order/141 - 26.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/141 - 27.webp",
        "../assets/img/made by order/141 - 28.webp",
        "../assets/img/made by order/141 - 29.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/141 - 12.webp",
        "../assets/img/made by order/141 - 13.webp",
        "../assets/img/made by order/141 - 14.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/119 - 25.webp",
        "../assets/img/made by order/119 - 26.webp",
        "../assets/img/made by order/119 - 27.webp",
        "../assets/img/made by order/119 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/119 - 9.webp",
        "../assets/img/made by order/119 - 10.webp",
        "../assets/img/made by order/119 - 11.webp",
        "../assets/img/made by order/119 - 12.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/123 - 12.webp",
        "../assets/img/made by order/126 - 3.webp",
        "../assets/img/made by order/123 - 13.webp",
        "../assets/img/made by order/123 - 14.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/130 - 15.webp",
        "../assets/img/made by order/130 - 16.webp",
        "../assets/img/made by order/130 - 17.webp",
        "../assets/img/made by order/130 - 18.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/148 - 26.webp",
        "../assets/img/made by order/148 - 27.webp",
        "../assets/img/made by order/148 - 28.webp",
        "../assets/img/made by order/148 - 29.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/115 - 17.webp",
        "../assets/img/bespoke/115 - 18.webp",
        "../assets/img/bespoke/115 - 19.webp",
        "../assets/img/bespoke/115 - 20.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/127 - 25.webp",
        "../assets/img/made by order/127 - 26.webp",
        "../assets/img/made by order/127 - 27.webp",
        "../assets/img/made by order/127 - 28.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/130 - 19.webp",
        "../assets/img/made by order/130 - 20.webp",
        "../assets/img/made by order/130 - 21.webp",
        "../assets/img/made by order/130 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/made by order/128 - 10.webp",
        "../assets/img/made by order/128 - 11.webp",
        "../assets/img/made by order/128 - 12.webp",
        "../assets/img/made by order/128 - 13.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/112 - 1.webp",
        "../assets/img/bespoke/112 - 2.webp",
        "../assets/img/bespoke/112 - 3.webp",
        "../assets/img/bespoke/112 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/142 - 24.webp",
        "../assets/img/bespoke/142 - 25.webp",
        "../assets/img/bespoke/142 - 26.webp",
        "../assets/img/bespoke/142 - 27.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/139 - 7.webp",
        "../assets/img/bespoke/112 - 18.webp",
        "../assets/img/bespoke/112 - 19.webp",
        "../assets/img/bespoke/112 - 20.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/150 - 25.webp",
        "../assets/img/bespoke/150 - 26.webp",
        "../assets/img/bespoke/150 - 27.webp",
        "../assets/img/bespoke/112 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/112 - 5.webp",
        "../assets/img/bespoke/112 - 6.webp",
        "../assets/img/bespoke/112 - 7.webp",
        "../assets/img/bespoke/112 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/140 - 31.webp",
        "../assets/img/bespoke/140 - 32.webp",
        "../assets/img/bespoke/140 - 33.webp",
        "../assets/img/bespoke/140 - 34.webp",
      ],
    },
    {
      id: "Derby-1116-Maiz",
      ...
      imagenes: [
        "../assets/img/bespoke/113 - 5.webp",
        "../assets/img/bespoke/113 - 6.webp",
        "../assets/img/bespoke/113 - 7.webp",
        "../assets/img/bespoke/113 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/150 - 28.webp",
        "../assets/img/bespoke/113 - 10.webp",
        "../assets/img/bespoke/113 - 11.webp",
        "../assets/img/bespoke/113 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/123 - 20.webp",
        "../assets/img/bespoke/123 - 21.webp",
        "../assets/img/bespoke/123 - 22.webp",
        "../assets/img/bespoke/113 - 8.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/113 - 12.webp",
        "../assets/img/bespoke/113 - 13.webp",
        "../assets/img/bespoke/113 - 14.webp",
        "../assets/img/bespoke/113 - 15.webp",
      ],
    },
    {
      id: "Swann-Museum",
      ...
      imagenes: [
        "../assets/img/bespoke/123 - 16.webp",
        "../assets/img/bespoke/123 - 17.webp",
        "../assets/img/bespoke/112 - 11.webp",
        "../assets/img/bespoke/112 - 12.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/115 - 9.webp",
        "../assets/img/bespoke/115 - 10.webp",
        "../assets/img/bespoke/115 - 11.webp",
        "../assets/img/bespoke/115 - 12.webp",
      ],
    },
    {
      id: "Bota-Inglesa-Negro",
      ...
      imagenes: [
        "../assets/img/bespoke/114 - 8.webp",
        "../assets/img/bespoke/114 - 9.webp",
        "../assets/img/bespoke/114 - 10.webp",
        "../assets/img/bespoke/113 - 19.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/123 - 36.webp",
        "../assets/img/bespoke/123 - 37.webp",
        "../assets/img/bespoke/123 - 38.webp",
        "../assets/img/bespoke/123 - 39.webp",
      ],
    },
    {
      id: "1116-Bespoke",
      ...
      imagenes: [
        "../assets/img/bespoke/114 - 19.webp",
        "../assets/img/bespoke/114 - 20.webp",
        "../assets/img/bespoke/114 - 21.webp",
        "../assets/img/bespoke/114 - 22.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/123 - 24.webp",
        "../assets/img/bespoke/123 - 25.webp",
        "../assets/img/bespoke/123 - 26.webp",
        "../assets/img/bespoke/123 - 27.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/123 - 28.webp",
        "../assets/img/bespoke/123 - 29.webp",
        "../assets/img/bespoke/123 - 30.webp",
        "../assets/img/bespoke/123 - 31.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/130 - 1.webp",
        "../assets/img/bespoke/130 - 2.webp",
        "../assets/img/bespoke/130 - 3.webp",
        "../assets/img/bespoke/130 - 4.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/113 - 16.webp",
        "../assets/img/bespoke/113 - 17.webp",
        "../assets/img/bespoke/113 - 18.webp",
        "../assets/img/bespoke/113 - 19.webp",
      ],
    },
    {
      ...
      imagenes: [
        "../assets/img/bespoke/117 - 6.webp",
        "../assets/img/bespoke/117 - 7.webp",
        "../assets/img/bespoke/117 - 8.webp",
        "../assets/img/bespoke/117 - 9.webp",
      ],
    },
    {
      ...
      estilo: "READY TO WEAR",
      descripcion:
        "Este modelo es un cinturón de estilo rústico Se caracteriza por su textura más áspera y su ancho de 5,5 centímetros.",
      color: "Maíz",
      tipoCuero: "Vacuno",
    ...
    },
    {
      ...
      estilo: "ACCESORIOS",
      descripcion:
        "Este modelo es un cinturón de estilo clásico que cuenta con una hebilla plateada y un ancho de 5 centímetros.",
      color: "Guinda",
      tipoCuero: "Vacuno",
  ...
  if (producto) {
    ...
    document.getElementById("descripcion-modelo").textContent =
      producto.descripcion
    document.getElementById("color-modelo").textContent = `${producto.color}`
    document.getElementById(
      "cuero-modelo"
    ).textContent = `${producto.tipoCuero}`
    ...
    if (
      ...
      preciosModelos.hasOwnProperty(producto.precio)
    ) {
      ...
      precioElemento.textContent = `$ ${producto.precio.toLocaleString(
        "es-AR"
      )}`
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  botonesCategorias.forEach((boton) => {
    boton.addEventListener("click", function (event) {
      ...
      const subcategoriasContainer = document.querySelector(
        `.contenedor-card_shoe_models[data-categoria="${categoriaSeleccionada}"]`
      )
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const zapatosLink = document.querySelector(
    '.button-card_models[data-categoria="zapatos"]'
  )
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const mocasinesLink = document.querySelector(
    '.button-card_models[data-categoria="mocasines"]'
  )

  // Obtener el contenedor de subcategorías de mocasines
  const subcategoriasMocasinesContainer = document.querySelector(
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const categoriasPrincipalesExceptoMocasines = document.querySelectorAll(
    '.button-card_models:not([data-categoria="mocasines"])'
  )
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const categoriasPrincipales = document.querySelectorAll(
    '.button-card_models:not([data-categoria="zapatos"])'
  )
  ...
  function aplicarFiltro(categoria) {
    ...
    productos.forEach((producto) => {
      ...
      if (
        !categoria ||
        categoria === "null" ||
        categoria === subcategoriaProducto
      ) {
        producto.style.display = "block"
      } else {
        producto.style.display = "none"
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  botonLimpiarFiltros.addEventListener("click", function (event) {
    ...
    const subcategorias = document.querySelectorAll(".button-card_shoe_models")
    subcategorias.forEach((subcategoria) =>
      subcategoria.classList.remove("seleccionado")
    )
  })
})
  ...
  function aplicarFiltro() {
    ...
    productos.forEach((producto) => {
      ...
      if (
        (!categoriaURL ||
          categoriaURL === "null" ||
          categoriaURL === categoriaProducto) &&
        (!subcategoriaURL ||
          subcategoriaURL === "null" ||
          subcategoriaURL === subcategoriaProducto)
      ) {
        producto.style.display = "block"
      } else {
        producto.style.display = "none"
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function verificarTamañoPantalla() {
    if (window.matchMedia("(max-width: 768px)").matches) {
      // Dispositivo móvil
      document.querySelector(".contenedor-card_shoe_models").style.visibility =
        "hidden"
    } else {
      // Versión web
      document.querySelector(".contenedor-card_shoe_models").style.visibility =
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const categoriasNoZapatos = document.querySelectorAll(
    '.button-card_models:not([data-categoria="zapatos"])'
  )

  // Obtener el contenedor de subcategorías para la versión móvil
  const subcategoriasMobile = document.querySelector(
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const subcategoriasMocasinesMobile = document.querySelector(
